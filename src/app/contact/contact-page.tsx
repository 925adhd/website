              ...
              {formState === 'success' ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button
                    ...
                    className="w-full rounded-xl bg-brand-teal-dark text-white font-bold py-3.5 px-6 hover:bg-[#24a68e] transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                  >
